...
The [insect centaurs](../../directory/FoldedBelow/Hippareiones.md) are excited and anxious for the party to open the east door.
They seem unable to do so themselves.
Once Drake opens it, all three flee as fast as they can towards a dark cavern.
They leave the [underground temple](../../directory/FoldedBelow/UndergroundTemple.md).
...
When [Indigo](../../directory/Deverain/Indigo.md) tries to move the statue, he sees a vision of one of [the Sisters](../../directory/weepingMother/theSisters.md).
...
The wall is also moveable, and the group finds a [reptiloid](../../directory/FoldedBelow/Reptiloids.md).
